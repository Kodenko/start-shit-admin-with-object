...
use App\Actions\Users\UserGetAllContactAction;
...
class AdminContactController extends Controller
{
    ...
    {
        return  view('admin.pages.contacts-index', ['contacts' => (new UserGetAllContactAction())->run()]);
    }
    ...
    {
        $data = (new GetAllRelationsInfoAction())->run('contact',UserData::fromRequest($request));
    ...
    {
        $data = (new GetAllRelationsInfoAction())->run('contact',$id);
        return view('admin.pages.contact-edit',$data);
    }
